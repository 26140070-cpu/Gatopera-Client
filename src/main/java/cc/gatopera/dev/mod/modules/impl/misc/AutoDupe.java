...
import cc.gatopera.dev.api.utils.entity.MovementUtil;
import cc.gatopera.dev.api.utils.math.Timer;
import cc.gatopera.dev.api.utils.world.BlockUtil;
import cc.gatopera.dev.asm.accessors.ILivingEntity;
...
import cc.gatopera.dev.mod.modules.impl.combat.KillAura;
import cc.gatopera.dev.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        Gatopera.ROTATION.snapAt(Gatopera.ROTATION.lastYaw, 89);
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            Gatopera.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = Gatopera.ROTATION.getRotation(pos.toCenterPos())[0];
