...
import cc.gatopera.dev.api.events.impl.ClickBlockEvent;
...
import cc.gatopera.dev.asm.accessors.IPlayerMoveC2SPacket;
...
import cc.gatopera.dev.mod.modules.impl.combat.AutoAnchor;
import cc.gatopera.dev.mod.modules.impl.combat.AutoCev;
import cc.gatopera.dev.mod.modules.impl.combat.AutoCrystal;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = Gatopera.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
