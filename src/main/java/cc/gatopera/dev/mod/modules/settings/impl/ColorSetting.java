...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(Gatopera.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Gatopera.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Gatopera.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
