...
import cc.gatopera.dev.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        cc.gatopera.dev.mod.modules.impl.render.Shader shaderChams = cc.gatopera.dev.mod.modules.impl.render.Shader.INSTANCE;
