...
import cc.gatopera.dev.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public void loadSettings() {
		for (Module module : Gatopera.MODULE.modules) {
			...
			module.setState(Gatopera.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("armor_x:" + Gatopera.GUI.armorHud.getX());
			printwriter.println("armor_y:" + Gatopera.GUI.armorHud.getY());
			...
			System.out.println("[" + Gatopera.NAME + "] Failed to save settings");
		} finally {
